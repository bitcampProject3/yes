...
(function (factory) {
     ...
     */
    function Clndr2(element, options) {
        var dayDiff;
        var constraintEnd;
        var constraintStart;
     ...
     */
    Clndr2.prototype.init = function () {
    ...
    Clndr2.prototype.shiftWeekdayLabels = function (offset) {
     ...
     */
    Clndr2.prototype.createDaysObject = function (startDate, endDate) {
    ...
    Clndr2.prototype.createDayObject = function (day, monthEvents) {
        var j = 0,
            self = this,
            now = moment(),
            eventsToday = [],
        ...
        // uniqueness of IDs.
        extraClasses += " calendar2-day-" + day.format("YYYY-MM-DD");
        // Day of week
    ...
    Clndr2.prototype.render = function () {
    ...
    Clndr2.prototype.bindEvents = function () {
        var data = {},
            self = this,
     ...
     */
    Clndr2.prototype.buildTargetObject = function (currentTarget, targetWasDay) {
     ...
     */
    Clndr2.prototype.getTargetDateString = function (target) {
        // Our identifier is in the list of classNames. Find it!
        var classNameIndex = target.className.indexOf('calendar2-day-');
     ...
     */
    Clndr2.prototype.triggerEvents = function (ctx, orig) {
     ...
     */
    Clndr2.prototype.back = function (options /*, ctx */) {
    ...
    Clndr2.prototype.backAction = function (event) {
        var ctx = event.data.context;
        ctx.backActionWithContext(ctx);
    };

    Clndr2.prototype.backActionWithContext = function (ctx) {
        ctx.back({
            withCallbacks: true
        }, ctx);
    };

    Clndr2.prototype.previous = function (options) {
        // Alias
     ...
     */
    Clndr2.prototype.forward = function (options /*, ctx */) {
    ...
    Clndr2.prototype.forwardAction = function (event) {
        var ctx = event.data.context;
        ctx.forwardActionWithContext(ctx);
    };

    Clndr2.prototype.forwardActionWithContext = function (ctx) {
        ctx.forward({
            withCallbacks: true
        }, ctx);
    };

    Clndr2.prototype.next = function (options) {
        // Alias
     ...
     */
    Clndr2.prototype.previousYear = function (options /*, ctx */) {
        var ctx = (arguments.length > 1)
                ? arguments[1]
                : this,
            defaults = {
    ...
    Clndr2.prototype.previousYearAction = function (event) {
        var ctx = event.data.context;
        ctx.previousYear({
            withCallbacks: true
        }, ctx);
     ...
     */
    Clndr2.prototype.nextYear = function (options /*, ctx */) {
        var ctx = (arguments.length > 1)
                ? arguments[1]
                : this,
            defaults = {
    ...
    Clndr2.prototype.nextYearAction = function (event) {
        var ctx = event.data.context;
        ctx.nextYear({
            withCallbacks: true
        }, ctx);
    ...
    Clndr2.prototype.today = function (options /*, ctx */) {
        var ctx = (arguments.length > 1)
                ? arguments[1]
                : this,
            timeOpt = ctx.options.lengthOfTime,
    ...
    Clndr2.prototype.todayAction = function (event) {
        var ctx = event.data.context;
        ctx.today({
            withCallbacks: true
        }, ctx);
     ...
     * "February", "Mar", etc.
     */
    Clndr2.prototype.setMonth = function (newMonth, options) {
    ...
    Clndr2.prototype.setYear = function (newYear, options) {
        var orig = {
            end: this.intervalEnd.clone(),
            start: this.intervalStart.clone()
        };
     ...
     */
    Clndr2.prototype.setIntervalStart = function (newDate, options) {
        var timeOpt = this.options.lengthOfTime,
            orig = {
                end: this.intervalEnd.clone(),
                start: this.intervalStart.clone()
     ...
     */
    Clndr2.prototype.setEvents = function (events) {
     ...
     */
    Clndr2.prototype.addEvents = function (events /*, reRender*/) {
     ...
     */
    Clndr2.prototype.removeEvents = function (matchingFn) {
    ...
    Clndr2.prototype.addMomentObjectToEvents = function (events) {
        var i = 0,
            self = this;
    ...
    Clndr2.prototype.addMultiDayMomentObjectsToEvents = function (events) {
        var i = 0,
            self = this,
    ...
    Clndr2.prototype.calendarDay = function (options) {
        var defaults = {
            day: "",
            date: null,
            events: [],
    ...
    Clndr2.prototype.destroy = function () {
    ...
    $.fn.clndr2 = function (options) {
        ...
        if (!this.data('plugin_clndr')) {
            clndrInstance = new Clndr2(this, options);
