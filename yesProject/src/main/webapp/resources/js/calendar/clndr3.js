...
(function (factory) {
     ...
     */
    function Clndr3(element, options) {
        var dayDiff;
        var constraintEnd;
        var constraintStart;
     ...
     */
    Clndr3.prototype.init = function () {
    ...
    Clndr3.prototype.shiftWeekdayLabels = function (offset) {
     ...
     */
    Clndr3.prototype.createDaysObject = function (startDate, endDate) {
    ...
    Clndr3.prototype.createDayObject = function (day, monthEvents) {
        var j = 0,
            self = this,
            now = moment(),
            eventsToday = [],
    ...
    Clndr3.prototype.render = function () {
    ...
    Clndr3.prototype.bindEvents = function () {
        var data = {},
            self = this,
     ...
     */
    Clndr3.prototype.buildTargetObject = function (currentTarget, targetWasDay) {
     ...
     */
    Clndr3.prototype.getTargetDateString = function (target) {
     ...
     */
    Clndr3.prototype.triggerEvents = function (ctx, orig) {
     ...
     */
    Clndr3.prototype.back = function (options /*, ctx */) {
    ...
    Clndr3.prototype.backAction = function (event) {
        var ctx = event.data.context;
        ctx.backActionWithContext(ctx);
    };

    Clndr3.prototype.backActionWithContext = function (ctx) {
        ctx.back({
            withCallbacks: true
        }, ctx);
    };

    Clndr3.prototype.previous = function (options) {
        // Alias
     ...
     */
    Clndr3.prototype.forward = function (options /*, ctx */) {
    ...
    Clndr3.prototype.forwardAction = function (event) {
        var ctx = event.data.context;
        ctx.forwardActionWithContext(ctx);
    };

    Clndr3.prototype.forwardActionWithContext = function (ctx) {
        ctx.forward({
            withCallbacks: true
        }, ctx);
    };

    Clndr3.prototype.next = function (options) {
        // Alias
     ...
     */
    Clndr3.prototype.previousYear = function (options /*, ctx */) {
        var ctx = (arguments.length > 1)
                ? arguments[1]
                : this,
            defaults = {
    ...
    Clndr3.prototype.previousYearAction = function (event) {
        var ctx = event.data.context;
        ctx.previousYear({
            withCallbacks: true
        }, ctx);
     ...
     */
    Clndr3.prototype.nextYear = function (options /*, ctx */) {
        var ctx = (arguments.length > 1)
                ? arguments[1]
                : this,
            defaults = {
    ...
    Clndr3.prototype.nextYearAction = function (event) {
        var ctx = event.data.context;
        ctx.nextYear({
            withCallbacks: true
        }, ctx);
    ...
    Clndr3.prototype.today = function (options /*, ctx */) {
        var ctx = (arguments.length > 1)
                ? arguments[1]
                : this,
            timeOpt = ctx.options.lengthOfTime,
    ...
    Clndr3.prototype.todayAction = function (event) {
        var ctx = event.data.context;
        ctx.today({
            withCallbacks: true
        }, ctx);
     ...
     * "February", "Mar", etc.
     */
    Clndr3.prototype.setMonth = function (newMonth, options) {
    ...
    Clndr3.prototype.setYear = function (newYear, options) {
        var orig = {
            end: this.intervalEnd.clone(),
            start: this.intervalStart.clone()
        };
     ...
     */
    Clndr3.prototype.setIntervalStart = function (newDate, options) {
        var timeOpt = this.options.lengthOfTime,
            orig = {
                end: this.intervalEnd.clone(),
                start: this.intervalStart.clone()
     ...
     */
    Clndr3.prototype.setEvents = function (events) {
     ...
     */
    Clndr3.prototype.addEvents = function (events /*, reRender*/) {
     ...
     */
    Clndr3.prototype.removeEvents = function (matchingFn) {
    ...
    Clndr3.prototype.addMomentObjectToEvents = function (events) {
        var i = 0,
            self = this;
    ...
    Clndr3.prototype.addMultiDayMomentObjectsToEvents = function (events) {
        var i = 0,
            self = this,
    ...
    Clndr3.prototype.calendarDay = function (options) {
        var defaults = {
            day: "",
            date: null,
            events: [],
    ...
    Clndr3.prototype.destroy = function () {
    ...
    $.fn.clndr3 = function (options) {
        ...
        if (!this.data('plugin_clndr')) {
            clndrInstance = new Clndr3(this, options);
