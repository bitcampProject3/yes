...
<html>
	...
	<script type="text/javascript">
		...
		form.setAttribute("target", "/yes/admin/AllListDetail");
...
*/
    ...
    <body>
        <div>
            ...
            <div style=" border: 1px solid #CCCCCC; padding-left:0px; padding-right:0px; 
               border-bottom-color: #e04f5f; margin-bottom:10px;">
                ...
                <div id="cube" class="col-xs-6 col-sm-4" style=" 
                  ...
                  border-right:1px solid darkgray;" 
                   ...
                   <div id="cube" class="col-xs-6 col-sm-4" style=" border-top: 1px solid darkgray;
                     cursor: pointer;" onclick="location.href='./branchList/'">
                      <h4>
                          <p class="text-center" style="padding-top: 5px;padding-bottom: 5px;">
                              사업자 리스트
                          </p>
