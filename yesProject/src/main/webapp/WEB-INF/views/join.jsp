...
<form>
  ...
  <input type="radio" name="assent" value="ok" /> 동의
  <input type="radio" name="assent" value="no" /> 동의하지않음
</form>
    <div style="margin-top: 30px; ">
        
    <a href="customerJoin.bit"  class="btn btn-primary"role="button">고객</a>
    <a href="branchJoin.bit" class="btn btn-primary" role="button">사업자</a>
    </div>    
  </div>
    </body>
</html>