        ...
        <div>
           ...
           <div class="container" style=" border-bottom: 1px solid; padding-left:0px; padding-right:0px; 
            ...
            <div style="padding-left: 40px; padding-right: 40px;">
                <header style="padding-top: 15px"><h4><b>사이트 이용을 하는데 어떻게 이용을 해야할지 모르겠어요...</b></h4></header>
                <div>
                   <section style="width: 100%; padding-bottom: 30px">
                   <article>     
                    <tr>
                        <td>
                            <b>문의유형 : <span>[지도 위치 표시 관련]</span></b>
                        </td>
                    </tr>
                    <br>
                    <tr>
                    ...
                    <div style="padding-bottom: 30px">
                        ...
                        다름이 아니라 사이트를 이용하는데 있어서 어떤 방식으로 예약이<br>
                        이루어지는지 잘 모르겠어서 문의드려봅니다<br><br>
                        
                        어떻게 이용을 하는지 자세한 설명좀 부탁드리겠습니다!!<br>
                        앞으로도 자주 이용할테니 얼릉 알려주세요!!!<br>
                        !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
