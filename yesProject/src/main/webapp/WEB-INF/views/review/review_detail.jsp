...
*/
	...
	<div class="carousel-inner" id="frame">
		...
		<div class="item active"> 
			<img src="../review_imgs/${mainImage.imageName }" style="width:100%" alt="First slide">
			<div class="container">
	...
	<c:forEach items="${subImages }" var="subImage">
		<!--슬라이드2-->
		<div class="item"> 
			<img src="../review_imgs/${subImage.imageName }" style="width:100%" data-src="" alt="Second slide">
			<div class="container">
				<div class="carousel-caption">
					<h1>Slide 2</h1>
					<p>텍스트 2</p>
