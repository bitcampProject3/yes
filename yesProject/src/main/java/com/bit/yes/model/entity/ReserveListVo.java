...
public class ReserveListVo {
	...
	public ReserveListVo(String branchID, String branchName, String clientID, String reserveTime, Date checkTime,
			int personel, String request, String useState) {
		super();
	...
	public String toString() {
		return "ReserveListVo [branchID=" + branchID + ", branchName=" + branchName + ", clientID=" + clientID
				+ ", reserveTime=" + reserveTime + ", checkTime=" + checkTime + ", personel=" + personel + ", request="
				+ request + ", useState=" + useState + "]";
	}
