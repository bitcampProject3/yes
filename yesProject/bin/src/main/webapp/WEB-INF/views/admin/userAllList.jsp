	...
	<div class="container" style="margin-top: 10px;">
		<div>
			...
			<div style="height: 30px;">
				<select onchange="visit(this)" style="float: left;">
					...
					<option value="/yes/admin/userAllList"><b>&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;모든
							회원 리스트</b></option>
					<!-- 상대경로 -->
					<option value="/yes/admin/userList"><b>&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;고객
							리스트</b></option>
					<!-- 상대경로 -->
					<option value="/yes/admin/branchList"><b>&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;사업자
							리스트</b></option>
					<!-- 상대경로 -->
		...
		<div class="row" style="margin-right: 0px; margin-left: 0px;">
			<div id="cube" class="col-xs-6 col-sm-4"
				style="border-top: 1px solid darkgray; border-left: 1px solid darkgray; color: white; background-color: #e04f5f; cursor: pointer;"
				onclick="location.href='./userAllList'">
				<h4>
					<p class="text-center"
						style="padding-top: 5px; padding-bottom: 5px;">모든 회원 리스트</p>
				</h4>
			</div>
			<div id="cube" class="col-xs-6 col-sm-4"
				...
				<h4>
					<p class="text-center"
						style="padding-top: 5px; padding-bottom: 5px;">고객 리스트</p>
				</h4>
			</div>
			<div id="cube" class="col-xs-6 col-sm-4"
				style="border-top: 1px solid darkgray; cursor: pointer; border-right: 1px solid darkgray;border-left:1px solid darkgray;"
				...
				<h4>
					<p class="text-center"
						style="padding-top: 5px; padding-bottom: 5px;">사업자 리스트</p>
				</h4>
			</div>
		</div>
		...
		<div class="text-center" style="display:block;">
			<div
				...
				<form method="post" action="/yes/admin/user_all_Search">
